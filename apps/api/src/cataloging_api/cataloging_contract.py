...
FIELDS: Final = (
    ...
    CatalogField(
        "country-found",
        "dc.coverage.countryFound",
        "País donde se encontró el recurso",
        "País donde se encontró el recurso",
    ),
    ...
    CatalogField(
        ...
        "Uso de lengua",
        controlled=True,
        vocabulary_id="languageUsagePairs",
    ),
    CatalogField(
        "registered-language",
    ...
    CatalogField(
        ...
        required=True,
        controlled=True,
        vocabulary_id="extentTypePairs",
    ),
    CatalogField(
        "extent",
        "dc.format.extent",
        "Número de páginas / extensión",
        "Número de páginas / extensión",
        required=True,
    ),
    ...
    CatalogField(
        ...
        "Derecho de acceso",
        controlled=True,
        vocabulary_id="accessRightsPairs",
    ),
    CatalogField(
        "physical-repository",
        "dc.source.physicalRepository",
        "Repositorio físico",
        "Repositorio físico",
        repeatable=True,
    ),
    CatalogField(
        "digital-url",
        "dc.identifier.url",
        "Repositorio digital (URL)",
        "Repositorio digital (URL)",
        repeatable=True,
    ),
    CatalogField(
        "primary-classification",
        "dc.subject.primaryClassification",
        "Clasificación primaria",
        "Clasificación primaria",
        controlled=True,
        vocabulary_id="primaryClassificationPairs",
    ),
    CatalogField(
        "keywords",
        "dc.subject",
    ...
    CatalogField(
        "language-target",
        "dc.audience.languageTarget",
        "Para L1 o para L2",
        "Para L1 o para L2",
        controlled=True,
        vocabulary_id="languageTargetPairs",
    ),
    CatalogField(
        "topics",
        "dc.subject",
        "Tópicos (disciplinas, temas específicos)",
        "Tópicos",
        repeatable=True,
        controlled=True,
        vocabulary_id="topicsPairs",
    ),
