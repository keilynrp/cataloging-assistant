...
14. `UX-ACCESSIBILITY-AUDIT-002` — responsive, zoom, keyboard and assistive-technology acceptance plan for v0.6.1. Status: `PROPOSED — NOT YET EXECUTED`; baseline `e74f22ebaffc9464f459a9d2282e4bf04eb4118c`.
