...
14. `UX-ACCESSIBILITY-AUDIT-002` — responsive, zoom, keyboard and assistive-technology audit for v0.6.1. Status: `COMPLETED — CORRECTIVE PROMPT REQUIRED`; baseline `e74f22ebaffc9464f459a9d2282e4bf04eb4118c`; `UXA002-REFLOW-001` recorded.
15. `UX-PROMPT-008` — tablet reflow correction at `768 × 1024`. Status: `PROPOSED`; documents `UXA002-REFLOW-001` only and authorizes no execution.
